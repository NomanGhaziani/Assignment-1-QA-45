...
let names = ["usman", "hussain", "raza", "ali"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
let transportation = ["Honda bike", "civic car", "cycle"];
...
guestArr.map((items) => console.log(`Dear ${items}, you are invited in the more people category list on dinner`));
...
let guests = ["nimra", "noor", "sana", "sadia"];
...
let placesToVisit = ["Tokyo", "Pakistan", "Turkey", "Japan"];
...
let country = ["Pakistan", "U.A.E", "Turkey"];
...
let person = { name: "Noman", fname: "Saleem", age: 26 };
console.log(person);
...
let name_1 = "Noman";
let name_2 = "Noman Ghazaini";
let name_3 = "Sir Noman Ghaziani";
// if (name_1 == name_3)[
...
const magicians2 = ["ALI", "HAMZA", "BILAL"];
...
const magicians3 = ["ALI", "HAMZA", "BILAL"];
